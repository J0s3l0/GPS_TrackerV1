...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`1063645_user`@`localhost` PROCEDURE `prcDeleteRoute`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`1063645_user`@`localhost` PROCEDURE `prcGetAllRoutesForMap`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`1063645_user`@`localhost` PROCEDURE `prcGetRouteForMap`(
_sessionID VARCHAR(50))
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`1063645_user`@`localhost` PROCEDURE `prcGetRoutes`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`1063645_user`@`localhost` PROCEDURE `prcSaveGPSLocation`(
